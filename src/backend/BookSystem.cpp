...
void BookSystem::Buy(const string &code, int quantity)
{
  ...
  log.Insert(executor.GetName(), "Buy " + std::to_string(quantity)
             + " " + info.name + ".");
                        ...
                        const string &keyword, long double price)
{
  ...
  log.Insert(executor.GetName(), string("Modify book ") + info.name + ".");
}
...
void BookSystem::Import(int id, int quantity, long double total_cost)
{
  ...
  log.Insert(executor.GetName(), "Import " + std::to_string(quantity)
